...
const Contact = ({
  ...
  return (
    <div className="flex flex-1 items-center justify-center relative p-5 md:p-10 w-full contact-wrapper">
      ...
      <div className="bg-white inline-block p-10 md:p-20 border contact text-center z-10 border-black md:px-32">
